...
public class ModificarCategoria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(txtGanancia, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void cargarDatos(int id) {
        categoria = control.getControladoraCategoria().leerCategoria(id);
        txtNombre.setText(categoria.getNombre());
        txtGanancia.setText(String.valueOf(categoria.getGanancia()));
    }
}
