...
public class ConfiguracionesUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnVolver1.setBackground(new java.awt.Color(102, 0, 102));
        btnVolver1.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        btnVolver1.setForeground(new java.awt.Color(255, 255, 255));
        btnVolver1.setIcon(loadImage("btn_volver.png"));
        btnVolver1.setText("Volver");
        btnVolver1.setBorderPainted(false);
        btnVolver1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnVolver1.setMaximumSize(new java.awt.Dimension(500, 300));
        btnVolver1.setMinimumSize(new java.awt.Dimension(80, 30));
        btnVolver1.setPreferredSize(new java.awt.Dimension(80, 30));
