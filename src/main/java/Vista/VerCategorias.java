...
public class VerCategorias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEliminar.setBackground(new java.awt.Color(200, 0, 180));
        ...
        btnModificar.setBackground(new java.awt.Color(200, 0, 180));
        ...
        jLabel6.setText("VER CATEGORÍAS");
        ...
        jLabel7.setBackground(new java.awt.Color(150, 0, 135));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (jtCategorias.getRowCount() > 0) {
            int filaSelect = jtCategorias.getSelectedRow();
            //Asegurar selección
            if (filaSelect != -1) {
                Categoria categoriaSelect = categorias.get(filaSelect);
                boolean conf = confirmar("¿Desea eliminar esta categoría?");
                if (conf) {
                    control.getControladoraCategoria().eliminarCategoria(categoriaSelect.getIdCategoria());
                    mostrarMensaje("Categoría eliminada", "informacion");
                    cargarTabla();
                }
            } else {
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        RegistrarCategoria log = new RegistrarCategoria();
        abrirVentana(log);
    ...
    public String mostrarEnPorcentaje(double numeroDecimal) {
        // Convertir el número a porcentaje (multiplicar por 100)
        int porcentaje = (int) (numeroDecimal * 100);

        // Retornar el resultado en formato de porcentaje
        return porcentaje + "%";
    }
    ...
    private void cargarTabla() {
        ...
        for (Categoria cat : categorias) {
            Object[] obj = {
                cat.getNombre(),
                mostrarEnPorcentaje(cat.getGanancia())
            };
        ...
        for (int i = 0; i < jtCategorias.getColumnCount(); i++) {
            jtCategorias.getColumnModel().getColumn(i).setCellRenderer(centrado);
        }
    }
}
